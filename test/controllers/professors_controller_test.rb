...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { age: @professor.age, gender: @professor.gender, name: @professor.name } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { age: @professor.age, gender: @professor.gender, name: @professor.name } }
